    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" >
          ...
          <el-table-column label="类型" align="center" key="uavTypeName" prop="uavTypeName"  :show-overflow-tooltip="true" />
          ...
          <el-table-column label="保险单号" align="center" key="chitNo" prop="chitNo" :show-overflow-tooltip="true" />
          <el-table-column label="所属用户" align="center" key="nickName" prop="nickName" :show-overflow-tooltip="true" />
